...
public class editFood extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> catagory_adapter = new ArrayAdapter<String>(editFood.this, android.R.layout.simple_expandable_list_item_1, getResources().getStringArray(R.array.catagory));
